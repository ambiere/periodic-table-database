...
--
-- Name: properties ftype_id; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT ftype_id FOREIGN KEY (type_id) REFERENCES public.types(type_id);
...
--
-- freecodecampQL database dump complete
--
